<x-layouts.app title="Domain Registration" description="Compare active domain registration and renewal pricing available through Colors Nepal.">
    <section class="relative overflow-hidden bg-ink-950 py-20 text-white sm:py-24">
        ...
        <div class="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <nav class="text-sm text-slate-400" aria-label="Breadcrumb"><a href="{{ route('home') }}" class="hover:text-white">Home</a><span class="mx-2" aria-hidden="true">/</span><span aria-current="page">Domains</span></nav>
    ...
    <section class="py-20 sm:py-24">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            @if ($domains->isNotEmpty())
                <div class="overflow-hidden rounded-feature border border-slate-200 bg-white shadow-card">
    ...
    <section class="px-4 pb-20 sm:px-6 sm:pb-24 lg:px-8">
        <div class="mx-auto max-w-5xl rounded-feature bg-brand-600 px-6 py-12 text-white sm:px-10 lg:flex lg:items-center lg:justify-between">
