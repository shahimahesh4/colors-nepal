...
<label class="block">
    ...
    <input
        ...
        {{ $attributes->class('min-h-11 w-full rounded-control border border-slate-300 bg-white px-3.5 py-2.5 text-slate-950 shadow-sm placeholder:text-slate-400 hover:border-slate-400 focus:border-brand-600 focus:ring-2 focus:ring-brand-100') }}
    >
